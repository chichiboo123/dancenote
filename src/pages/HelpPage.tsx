...
const STEPS = [
  {
    ...
    lines: [
      ...
      '실제 무대 길이를 알면 사용자 지정을 눌러 가로·세로를 직접 적어요.',
    ],
  },
  {
  ...
  },
  {
    ...
    lines: [
      ...
      '두 번째 컷부터는 "지난 컷처럼 이름 붙이기"를 누르면 한 번에 이름이 붙어요.',
      '사람이 작게 보이면 사진 오른쪽 아래 돋보기(+)로 크게 볼 수 있어요.',
      '못 찾은 친구는 빈 곳을 꾹 길게 누르면 직접 넣을 수 있어요.',
      '사람이 아닌 네모는 눌러서 "사람 아니에요"로 지워요.',
      '평면도의 동그란 이름표는 끌어서 자리를 고칠 수 있어요.',
      '끌다 보면 다른 친구·무대 가운데·무대 앞 번호에 줄이 맞춰져 착 붙어요. 친구 사이 거리(m)도 보여요.',
      '이름표를 누르고 "여러 명 고르기"를 켜면 여러 명을 고를 수 있어요. (PC는 Ctrl·⌘ 누르고 클릭) 한 명을 끌면 모두 함께 움직여요.',
      '빈 바닥에서 끌어 네모를 그리면 그 안의 친구들을 한꺼번에 골라요.',
      '이름표 크기는 평면도 아래 "작게 · 보통 · 크게"로 바꿔요.',
      '다 했으면 "다음 컷"을 눌러 바로 다음 컷으로 넘어가요.',
    ],
  },
  {
